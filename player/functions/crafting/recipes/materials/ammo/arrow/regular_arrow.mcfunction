...
execute store result score @s ingred_count run data get entity @s EnderItems[1].tag.items.materials.misc.natural.chipped_rock 1
execute if score @s ingred_count matches 2.. run scoreboard players add @s display_craft 1
execute store result score @s ingred_count run data get entity @s EnderItems[1].tag.items.materials.misc.natural.twig 1
execute if score @s ingred_count matches 4.. run scoreboard players add @s display_craft 1
execute store result score @s ingred_count run data get entity @s EnderItems[1].tag.items.materials.mob_drops.passive.chicken.feather 1
execute if score @s ingred_count matches 2.. run scoreboard players add @s display_craft 1
