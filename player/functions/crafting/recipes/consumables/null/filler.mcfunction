...
execute store result score @s ingred_count run data get entity @s EnderItems[{Slot:1b}].tag.items.materials.null.null 1
execute if score @s ingred_count matches 999.. run scoreboard players add @s display_craft 1
