...
function ui:crafting/crafts_list/check_recipes/materials
execute if score @s craft_unlocked matches 1 run function ui:crafting/crafts_list/add_craft
execute unless score @s recipe_id matches 1.. run function ui:crafting/crafts_list/categories/materials
