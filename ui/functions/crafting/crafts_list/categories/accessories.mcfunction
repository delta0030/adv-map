...
execute unless score @s recipe_id matches 0.. run function ui:crafting/crafts_list/main

execute if score @s recipe_id matches 0.. run tag @s add list_complete