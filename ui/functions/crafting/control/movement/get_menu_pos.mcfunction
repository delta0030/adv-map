...
execute unless score @s move_dir matches 0 unless score @s move_dir matches 5 run tp @s @e[type=area_effect_cloud,tag=craft_center,sort=nearest,limit=1]
...
execute store result score %val1 crafting run data get entity @s EnderItems[{Slot:1b}].tag.available_crafts[-1][0]
execute if score @s[tag=!ui_cooldown] move_dir matches 2 unless score %val1 crafting matches 0 run function ui:crafting/control/movement/scroll_up

execute store result score %val2 crafting run data get entity @s EnderItems[{Slot:1b}].tag.available_crafts[1][0]
execute if score @s[tag=!ui_cooldown] move_dir matches 4 unless score %val2 crafting matches 0 run function ui:crafting/control/movement/scroll_down
...
execute store result score %selected_recipe crafting run data get entity @s EnderItems[{Slot:1b}].tag.available_crafts[0][0]