...
execute if entity @e[type=armor_stand,tag=swmb1_fire] if entity @e[type=vindicator,tag=swmb1] run schedule function entities:mobs/types/dungeon/singwoods/guardian/fire_fountain/buffer 1t