execute if score out math11 matches 157 run function entities:mobs/types/executioner/summon
execute if score out math11 matches 7635 run function entities:mobs/types/executioner/summon
execute if score out math11 matches 16394 run function entities:mobs/types/executioner/summon
...
execute unless entity @e[tag=executioner] if score %try exeSpawn matches 1 run function entities:mobs/types/executioner/init

# change souuce of testing to save on system resources
schedule function entities:mobs/types/executioner/test 1t