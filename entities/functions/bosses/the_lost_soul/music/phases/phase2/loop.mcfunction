execute if score %phase tls_music matches 2 if score %timer tls_music matches 1 if score %intro2_full tls_music matches 1 run playsound bosses.boss_2.loop2 hostile @s
