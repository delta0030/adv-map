...
execute if score %bool2 tls_tp matches 1 run tp @e[type=stray,tag=boss_2] ~ ~ ~ facing entity @p

execute if score %bool2 tls_tp matches 0 positioned ^ ^ ^0.25 unless block ~ ~ ~ air positioned ^ ^ ^-1 run tp @e[type=stray,tag=boss_2] ~ ~ ~ facing entity @p
