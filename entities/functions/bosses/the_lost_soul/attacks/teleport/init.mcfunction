execute positioned 70.5 52.00 -160.5 run summon minecraft:area_effect_cloud ~ ~ ~ {Age:-2147483648,Duration:-1,WaitTime:-2147483648,Tags:["tls_tp_center"]}
...
execute as @e[type=area_effect_cloud,tag=tls_tp_center] at @s run function entities:bosses/the_lost_soul/attacks/teleport/main
