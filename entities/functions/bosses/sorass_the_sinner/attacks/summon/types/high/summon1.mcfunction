...
summon zombie ~ ~ ~ {DeathLootTable:"entities:entities/hostile/dun1/armored_zombie",IsBaby:1b,Tags:["sts_sums","sts_sums1","new_mob","sts_sums_high","trogladyte"],ArmorItems:[{},{},{},{id:"minecraft:leather_helmet",Count:1b}]}
