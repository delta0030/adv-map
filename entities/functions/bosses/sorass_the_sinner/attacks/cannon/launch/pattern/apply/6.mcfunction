...
execute store result score @s motion_x2 run data get entity @e[type=armor_stand,tag=can_mark_6,limit=1] Pos[0] 1000
execute store result score @s motion_y2 run data get entity @e[type=armor_stand,tag=can_mark_6,limit=1] Pos[1] 1000
execute store result score @s motion_z2 run data get entity @e[type=armor_stand,tag=can_mark_6,limit=1] Pos[2] 1000
