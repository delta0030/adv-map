...
scoreboard players set %forest biome 0
scoreboard players set %desert biome 0
scoreboard players set %badlands biome 0
scoreboard players set %plains biome 0
scoreboard players set %ocean biome 0

#Courtesy of Cloudwolf -  So thank you
