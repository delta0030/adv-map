...
execute store result block 0 -1 0 Items[{Slot:1b}].tag.items.consumables.potions.healing.lesser_healing int 1 run scoreboard players get @s lesser_healing
item replace entity @s enderchest.1 from block 0 -1 0 container.1

scoreboard players set @s lesser_healing -1
