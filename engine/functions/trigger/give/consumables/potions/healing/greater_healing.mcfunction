...
execute store result block 0 -1 0 Items[{Slot:1b}].tag.items.consumables.potions.healing.greater_healing int 1 run scoreboard players get @s greater_healing
