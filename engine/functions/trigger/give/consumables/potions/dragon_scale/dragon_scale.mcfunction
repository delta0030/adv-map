...
execute store result block 0 -1 0 Items[{Slot:1b}].tag.items.consumables.potions.dragon_scale.dragon_scale int 1 run scoreboard players get @s dragon_scale
