...
execute store result block 0 -1 0 Items[{Slot:1b}].tag.items.materials.mob_drops.hostile.skeleton.bone int 1 run scoreboard players get @s bone
item replace entity @s enderchest.1 from block 0 -1 0 container.1

scoreboard players set @s bone -1
