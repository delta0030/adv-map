...
execute store result block 0 -1 0 Items[{Slot:1b}].tag.items.materials.mob_drops.hostile.bosses.globulous.gelatin int 1 run scoreboard players get @s gelatin
item replace entity @s enderchest.1 from block 0 -1 0 container.1

scoreboard players set @s gelatin -1
