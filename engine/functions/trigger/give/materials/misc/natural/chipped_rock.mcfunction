...
execute store result block 0 -1 0 Items[{Slot:1b}].tag.items.materials.misc.natural.chipped_rock int 1 run scoreboard players get @s chipped_rock
item replace entity @s enderchest.1 from block 0 -1 0 container.1

scoreboard players set @s chipped_rock -1
